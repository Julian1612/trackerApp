...
//    
//    // NEU: Tageszeit-Auswahl (Morgen, Tag, Abend)
//    @State private var routineTime: RoutineTime = .any
//    
//    @State private var showDeleteAlert = falseA
//
...
//                }
//                
//                // Zuweisung zur Routine (Morgen/Tag/Abend)
...
//                
//                // Reminder Sektion
//                Section(header: Text("Erinnerung").foregroundColor(.black)) {
...
//                days: selectedDays,
//                time: reminderTime, // Hier kommt das Datum hin
//                notifications: notificationEnabled,
//                category: category,
//                routineTime: routineTime // Hier kommt die RoutineTime (Morgen/Tag/Abend) hin [FIX]
//            )
//        }
//        dismiss()
//    }
